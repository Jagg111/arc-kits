...
export const GOAL_PRESETS: GoalPresets = {
  ...
  budget: {
    ...
    builds: {
      stitcher: { slots: { Muzzle: { fam: "Compensator", tier: 1 }, Underbarrel: { fam: "Vertical Grip", tier: 1 }, "Light Magazine": { fam: "Extended Light Magazine", tier: 1 } }, fix: "Cheap but effective" },
      tempest: { slots: { Muzzle: { fam: "Muzzle Brake", tier: 1 }, Underbarrel: { fam: "Angled Grip", tier: 1 }, "Medium Magazine": { fam: "Extended Medium Magazine", tier: 1 } }, fix: "T2 meta setup" },
      rattler: { slots: { Muzzle: { fam: "Compensator", tier: 1 }, Underbarrel: { fam: "Angled Grip", tier: 1 }, Stock: { fam: "Stable Stock", tier: 1 } }, fix: "Basic improvements" },
      ferro: { slots: { Stock: { fam: "Stable Stock", tier: 1 } }, fix: "Cheapest ARC killer" },
      bobcat: { slots: { Muzzle: { fam: "Muzzle Brake", tier: 1 }, Underbarrel: { fam: "Vertical Grip", tier: 1 }, "Light Magazine": { fam: "Extended Light Magazine", tier: 1 } }, fix: "Budget stable" },
      vulcano: { slots: { "Shotgun Muzzle": { fam: "Shotgun Choke", tier: 1 }, "Shotgun Magazine": { fam: "Extended Shotgun Magazine", tier: 1 } }, fix: "Essentials only" },
      iltoro: { slots: { "Shotgun Muzzle": { fam: "Shotgun Choke", tier: 1 }, "Shotgun Magazine": { fam: "Extended Shotgun Magazine", tier: 1 } }, fix: "Minimal cost" },
